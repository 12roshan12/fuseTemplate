...
export class NgxDatatableComponent implements OnInit, AfterContentInit,OnChanges {
    ...
    @Output() sortingclick: EventEmitter<any> = new EventEmitter<any>();
    @Output() statusfilterclick: EventEmitter<any> = new EventEmitter<any>();
    @Output() statusfilterBankclick: EventEmitter<any> = new EventEmitter<any>();
    @Output() itemperpage: EventEmitter<any> = new EventEmitter<any>();
    ...
    onClickOrderBy(colItem: any, index: number) {
        if (colItem.sorting == true) {
            ...
            this.sortingclick.emit(colItem);
        }
    }
    onRowClick(item: any) {
    ...
    statusfilter(value){
        this.statusfilterclick.emit(value.target.value)
    }
    statusfilterBank(value){
        this.statusfilterBankclick.emit(value.target.value)
    }
}
